...
-- 3️⃣Modificações com ALTER TABLE
...
-- 4️⃣Inserções e TRUNCATE
-- ● Insira pelo menos 1 registro em cada tabela
INSERT INTO Clientes (id, nome) VALUES (1, 'geovany');
INSERT INTO Filmes (id, nome) VALUES (1, 'geovany');
INSERT INTO locacoes (id, nome) VALUES (1, 'geovany');
